...
public:
  ...
  // uint32_t operator-( const Wrap32& other ) const { return raw_value_ - other.raw_value_ ; }
  uint32_t subtract( const Wrap32& other ) const { return raw_value_ - other.raw_value_ ; }
